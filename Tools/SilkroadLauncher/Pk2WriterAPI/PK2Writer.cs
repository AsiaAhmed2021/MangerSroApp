...
namespace Pk2WriterAPI
{
    public static class Pk2Writer
    {
        ...
        {
            return System.IO.File.Exists(GFXDllFilename) ? _Initialize(GFXDllFilename) : false;
        }
        /// <summary>
        ...
        {
            return System.IO.File.Exists(Pk2Filename) ? _Open(Pk2Filename, BlowfishKey, BlowfishKey.Length) : false;
        }
        /// <summary>
