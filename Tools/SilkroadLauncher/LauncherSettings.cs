...
namespace SilkroadLauncher
{
    ...
    public static class LauncherSettings
    {
        ...
        public static Confing configMainApp = MangerSroApp.ExtensionsClass.Extensions.ConfingModels;

        // Client settings
        public static string
            CLIENTGFXFileManager_dll = @"C:\VsroCap100\Clinet\IronSro.v2\GFXFileManager.dll",
            CLIENT_EXECUTABLE = @"C:\VsroCap100\Clinet\IronSro.v2\sro_client.exe", // configMainApp.settingInI. //"sro_client.exe",
            CLIENT_BLOWFISH_KEY = "169841",
            CLIENT_MEDIA_PK2_PATH = @"C:\VsroCap100\Clinet\IronSro.v2\Media.pk2";
