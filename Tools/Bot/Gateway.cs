...
namespace MangerSroApp.Tools.Bot
{
    ...
    {
        public static Confing Confing = Globals.Confing;
                    ...
                    foreach (Packet packet in gw_packets)
                    {
                        ...
                        if (packet.Opcode == 0x2001)
                        {
                            if (packet.ReadAscii() == "GatewayServer")
                            {
                                ...
                                packet2.WriteUInt8(Globals.locale);
                                packet2.WriteAscii("SR_Client");
                                packet2.WriteUInt32(Globals.version);
                        ...
                        else
                        {
                            ...
                            if (packet.Opcode == 0xa102)
                            {
                                ...
                                if (num2 == 1)
                                {
                                    ...
                                    var Is = new Agent();
                                    Is.Start(iP, num4.ToString(), num3, Confing.bot.Bot_ID, Confing.bot.Bot_Password);
        ...
        {
            msg = string.Format(msg, values);
            Globals.SetGatewayEvent("Gateway", msg);
        }
        ...
        {
            Globals.GatewayIsReadyNow = false;
            Globals.ServerIsReady = false;
