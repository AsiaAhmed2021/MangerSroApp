...
namespace MangerSroApp
{
    public class Confing
    {
        ...
        public Client DirClient { set; get; }
        //-------------------------------------------------------
        ...
        public class Client
        {
            public string MainDir { set; get; }
            public string GetMedia { get => System.IO.Path.Combine(MainDir, "Media.pk2"); }
            public string GetMap { get => System.IO.Path.Combine(MainDir, "Map.pk2"); }
            public string GetMusic { get => System.IO.Path.Combine(MainDir, "Music.pk2"); }
            public string GetParticles { get => System.IO.Path.Combine(MainDir, "Particles.pk2"); }
            public string GetData { get => System.IO.Path.Combine(MainDir, "Data.pk2"); }
        }
